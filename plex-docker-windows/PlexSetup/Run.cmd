...
echo You can take ownership of a newly created server by navigating to one of this IP address on port 32400 (HTTP) using a web browser from a computer on the same local network
